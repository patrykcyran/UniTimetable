...
public class OneTimeEventFactory implements CalendarEventFactory {

    List<OneTimeEvent> oneTimeEventList;

    public OneTimeEventFactory(List<OneTimeEvent> oneTimeEventList) {
        this.oneTimeEventList = oneTimeEventList;
    }
